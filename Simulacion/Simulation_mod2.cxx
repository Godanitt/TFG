...
*/
void Simulation_mod2(double tBeam = 7.5, double Ex = 0.0, int interacciones = 1000000)
{
    ...
    */
    ...
    for(int i = 0; i < interacciones; i++)
    {
        ...
        // erǵia del haz.
        auto r {vertex.X()};
        auto tBeamNew {srim.SlowWithStraggling("beam", tBeam * p1.get_A(), r, 0 * TMath::DegToRad())};
        ...
        auto TAtSil0 {srim.SlowWithStraggling("light", t3, dist0)};
        ...
        // Eloss
        auto TAfterSil0 {srim.SlowWithStraggling("lightInSil", TAtSil0, thick0, angleNormal0)};
